...
let current_users = ['ADMIN', 'Hamza', 'Mazz', 'Fahad', 'JOHN'];
//new_users array
let new_users = ['Noor', 'Admin', 'Saba', 'Fatima', 'john'];
//loop through new users check for username availablity
new_users.forEach(new_one_user => {
    //making a condition to already exist    
    //make a our_condition variable to store true ya false value
    //When 2 array compare, use .some method its work one by one
    //.some boolean me value return krta hy
